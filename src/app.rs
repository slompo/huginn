...
pub struct AppState {
    ...
    /// Session title generated by AI (for resume context)
    pub session_title: Option<String>,

    /// Flag indicating we're waiting for session title generation
    pub generating_title: bool,

    /// Flag indicating first user prompt has been processed
    pub first_prompt_processed: bool,
}
